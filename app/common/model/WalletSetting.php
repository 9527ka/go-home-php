...
class WalletSetting
{
    ...
    const META = [
        ...
        'sign_bonus_10x_multiplier'  => ['description' => '暴击倍率3-倍数（默认10，钻石/至尊可享）', 'type' => 'number'],
        'sign_bonus_20x_multiplier'  => ['description' => '暴击倍率4-倍数（默认20，仅至尊可享）', 'type' => 'number'],
        'sign_bonus_2x_rate'         => ['description' => '暴击倍率1基础概率(%)，默认12', 'type' => 'number'],
        'sign_bonus_5x_rate'         => ['description' => '暴击倍率2基础概率(%)，默认3', 'type' => 'number'],
        'sign_bonus_10x_rate'        => ['description' => '暴击倍率3基础概率(%)，默认1', 'type' => 'number'],
        'sign_bonus_20x_rate'        => ['description' => '暴击倍率4基础概率(%)，默认1（仅至尊生效）', 'type' => 'number'],
        ...
        'nearby_enabled'             => ['description' => '附近启事推荐开关', 'type' => 'toggle'],
        'nearby_max_radius_km'       => ['description' => '附近查询最大半径(km)', 'type' => 'number'],
        'nearby_distance_weight'     => ['description' => '附近排序-距离权重(0-1)', 'type' => 'number'],
        'nearby_recency_weight'      => ['description' => '附近排序-时效权重(0-1)', 'type' => 'number'],
        'nearby_recency_decay_days'  => ['description' => '附近排序-时效衰减天数', 'type' => 'number'],
        'found_story_reward'         => ['description' => '填写找回故事奖励爱心币', 'type' => 'number'],
        'found_story_reward_enabled' => ['description' => '填写找回故事奖励开关', 'type' => 'toggle'],
    ];
